...
const aboutus = () => {
  return (
    <div class="container flex flex-col h-auto w-5/6 2xl:w-full xl:max-w-5xl items-center">
        <h1 class="text-text1Light dark:text-text1Dark mt-10 text-center text-3xl md:text-5xl 2xl:text-7xl md:mt-10">About Us</h1>
        <div class="flex flex-col pt-2 md:pt-6 md:flex-row h-fit transition-all xl:max-w-5xl 2xl:max-w-7xl">
          <img src="https://dummyimage.com/2500x1350/000000/ffffff" class="md:float-left h-auto md:h-fit rounded-md mx-6 md:mx-auto md:max-w-xs xl:max-w-sm mt-2 md:mt-0 md:mr-2" alt="About Us"></img>
