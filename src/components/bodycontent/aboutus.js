...
const aboutus = () => {
  return (
    <div class="container flex flex-col w-5/6 items-center mx-auto static 2xl:max-w-5xl">
        <h1 class="text-primary dark:text-white mt-5 text-center text-3xl md:text-5xl 2xl:text-6xl md:mt-10">About Us</h1>
        <div class="flex flex-col pt-2 md:pt-10 md:flex-row h-auto xl:h-48 transition-all">
          <img src={headerImage} class="float-left object-scale-down h-auto md:h-48 xl:h-auto mt-2 md:mr-2" alt="About Us"></img>
