...
const ourservices = () => {
  ...
  return (
    <div class="container flex flex-col h-auto items-center w-5/6 2xl:w-full">
        ...
        <div class="flex flex-col transition-all h-fit xl:max-w-7xl">
